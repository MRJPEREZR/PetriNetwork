...
public class MutexNetworkBouncerArcsTest {
	...
	public void setup() throws RepeatedNameElement, InvalidTokenNumber, InvalidWeightNumber, RepeatedArc, ElementNameNotExists {
		...
		net.addArc("a1_out", "t1", "p1", "outbouncer");
		net.addArc("a2_out", "t2", "p2", "outbouncer");
		net.addArc("a3_out", "t1", "p3", "outbouncer");
		net.addArc("a4_out", "t4", "p4", "outbouncer");
		net.addArc("a5_out", "t3", "p5", "outbouncer");
		net.addArc("a6_out", "t3", "p3", "outbouncer");
